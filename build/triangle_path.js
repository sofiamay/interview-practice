...
exports.getTrianglePath = exports.trianglePath = void 0;
function trianglePath(arr) {
    let n = arr.length;
...
function getTrianglePath(matrix, n, dp) {
...
exports.getTrianglePath = getTrianglePath;
exports.default = {
    trianglePath,
    getTrianglePath,
};
