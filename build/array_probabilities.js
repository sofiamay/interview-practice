...
exports.generateFromProbabilities = void 0;
function generateFromProbabilities(nums, probs) {
    const total = probs.reduce((partialSum, a) => partialSum + a, 0);
    if (total != 1)
        throw new Error(`probs arg: ${probs} must add to 1`);
    if (nums.length != probs.length)
        throw new Error(`nums and probs must be of the same length`);
...
exports.generateFromProbabilities = generateFromProbabilities;
exports.default = {
